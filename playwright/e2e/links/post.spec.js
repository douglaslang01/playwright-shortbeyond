...
test.describe('POST /api/links', () => {
    ...
    test('não deve encurtar quando o título original não é informada', async () => {
    ...
    test('não deve encurtar quando a url original é inválida', async () => {
        const response = await link.createLink({ ...user.link, original_url: 'douglas.lang@gmail.com' }, token);
